...
# Use local block processing with ollama instead of syncing from external API
HIVESENSE_CONFIGURATION=local
...
export HIVESENSE_CONFIGURATION HIVESENSE_SYNC_ARGS PUBLIC_HOSTNAME
